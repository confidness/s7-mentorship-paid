 ...
 *
 * The password is taken and deliberately dropped: Supabase Auth holds the credential, and
 * nothing here writes it anywhere. It stays in the signature because the caller still has
 * one to hand to Auth, and because a silently-ignored argument is better than a caller
 * that thinks it set a password it never did.
 */
